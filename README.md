...
- [ ] The booking buttons carry `buchung@ivypoledance.at` in their `mailto:` href, which is where a harvester will find an address whatever the pages display. It goes away with the booking form below
