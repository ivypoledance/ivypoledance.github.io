...
// headings the documents start from land on level 2 and keep the bold typst
// gives a heading. Their sub-headings are level 3, set in italic at the weight
// of the body text, so they read as a subdivision of the clause above them
